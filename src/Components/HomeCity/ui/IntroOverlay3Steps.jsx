...
// export default function IntroOverlay2Steps({
//   step,
//   setStep,
//   dontShowAgain,
//   setDontShowAgain,
...
//     el.style.transform = "translateY(-1px)";
//     el.style.filter = "brightness(1.05)";
//     el.style.borderColor = mode === "blue" ? "rgba(96,165,250,0.55)" : "rgba(255,0,170,0.55)";
//     el.style.boxShadow =
//       mode === "blue"
//         ? "0 0 0 1px rgba(96,165,250,0.16), 0 0 22px rgba(96,165,250,0.14)"
//         : "0 0 0 1px rgba(255,0,170,0.18), 0 0 28px rgba(255,0,170,0.16), 0 0 70px rgba(124,58,237,0.12)";
...
//   const body = { padding: 18, display: "grid", gap: 12 };
...
//   // copy Kasia vibe (no “Angels City” branding)
//   const KICKER = "KASIA NAGORKA / INTERACTIVE SPACE";
//   const TITLE_1 = "Welcome. Make yourself at home.";
//   const SUB_1 = "A mini-world: part portfolio, part playground. Explore, click, and jump straight to what matters.";
//   const TITLE_2 = "Quick controls. Zero drama.";
//   const SUB_2 = "Two keys and you’re in. (And yes — you can still escape anytime 😇)";
...
//           <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
//             <div>
//               <div style={appleKicker}>{KICKER}</div>
//               <div style={appleTitle}>{isStep1 ? TITLE_1 : TITLE_2}</div>
//               <div style={{ marginTop: 8, opacity: 0.78, fontSize: 13, maxWidth: 540 }}>
//                 {isStep1 ? SUB_1 : SUB_2}
//               </div>
//             </div>
...
//             <div style={badge}>
//               <span style={{ color: "rgba(255,0,170,1)", fontWeight: 900 }}>●</span> Step {step}/2
//             </div>
//           </div>
//         </div>
...
//             <>
//               <div style={terminal}>
//                 <div style={terminalTopLine} aria-hidden="true" />
//                 {cmd("boot: kasiaverse.exe")}
//                 {cmd("mode: interactive portfolio")}
//                 {cmd("hint: find ORBS → open PORTALS")}
//                 <div style={{ marginTop: 10, opacity: 0.85 }}>
//                   Press <b>SPACE</b> / <b>ENTER</b> to continue.
//                 </div>
//               </div>
...
//                 <div style={terminalTopLine} aria-hidden="true" />
//                 {cmd("ARROWS  → move")}
//                 {cmd("MOUSE   → look around")}
//                 {cmd("ESC     → unlock cursor")}
//                 <div style={{ marginTop: 10, opacity: 0.85 }}>
//                   Press <b>SPACE</b> / <b>ENTER</b> to enter.
//                 </div>
//               </div>
...
//             <label style={{ display: "flex", alignItems: "center", gap: 10, opacity: 0.92, cursor: "pointer" }}>
//               <input
//                 type="checkbox"
//                 checked={dontShowAgain}
//                 onChange={(e) => setDontShowAgain(e.target.checked)}
//                 style={{ width: 16, height: 16, accentColor: "rgb(255,0,170)" }}
//               />
//               <span style={{ fontSize: 12 }}>Don’t show again</span>
//             </label>

//             <div style={{ fontSize: 11, opacity: 0.75, textAlign: "right", fontFamily: monoFont }}>
//               tip: ESC unlocks the mouse
//             </div>
//           </div>
//         </div>
//       </div>
