...
// export default function MenuPreview({ activeKey, projectSlides, menuAssetsReady, instant = false }) {
//   const navigate = useNavigate();
...
//       return null;
//     },
//     [navigate, projectSlides, menuAssetsReady]
//   );
...
//     // ✅ MODE INSTANT: aucun blur / aucune transition
//     if (instant) {
//       // on kill toute anim potentielle au cas où
//       if (prevEl && nextEl) gsap.killTweensOf([prevEl, nextEl]);

//       // on met directement le nouveau contenu comme "prevKey"
//       setPrevKey(activeKey);

//       // et on reset toute propriété GSAP résiduelle
//       if (prevEl) gsap.set(prevEl, { clearProps: "filter,opacity,visibility" });
//       if (nextEl) gsap.set(nextEl, { clearProps: "filter,opacity,visibility" });

//       return;
//     }

//     // -------- (si un jour tu veux remettre une anim)
//     if (!prevEl || !nextEl) {
//       setPrevKey(activeKey);
//       return;
//     }
...
//     return () => tl.kill();
//   }, [activeKey, prevKey, instant]);

//   return (
//     <div className="homeOverlay__previewStage" data-preview={activeKey}>
//       {/* IMPORTANT : en mode instant on rend directement prevKey == activeKey (switch immédiat) */}
//       <div ref={prevRef} className="homeOverlay__previewLayer homeOverlay__previewLayer--prev">
//         {renderKey(prevKey, true)}
//       </div>

//       {/* On garde le next layer pour compat, mais en instant il ne sert plus */}
//       <div
//         ref={nextRef}
//         className="homeOverlay__previewLayer homeOverlay__previewLayer--next"
//         style={instant ? { display: "none" } : undefined}
//       >
...
// export default function MenuPreview({ activeKey, projectSlides, menuAssetsReady, instant }) {
//   const navigate = useNavigate();
...
//       if (nextEl) gsap.set(nextEl, { autoAlpha: 1, clearProps: "filter" });
//       return;
